...
public class adminNotificationController implements Initializable {
    ...
    private void handle(){
        ...
        String sql = "SELECT * FROM admin_notify order by n_id asc";
        try {
    ...
    private void retrievingData(String message, String username, String date){


        String finalMessage = message + " " + username + "\n" + "at " + date;
